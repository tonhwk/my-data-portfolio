...
`}
      ...
      <ul className="projects-list">
        <li><a href="https://www.kaggle.com/code/tonhwk/animal-bites-data-cleaning/" target="_blank" rel="noopener noreferrer">Project 1: Data Cleaning with Pandas</a></li>
        <li><a href="https://www.kaggle.com/code/tonhwk/data-preprocessing-titanic-dataset/" target="_blank" rel="noopener noreferrer">Project 2: Data Preprocessing for Machine Learning</a></li>
      </ul>
    </div>
  );
}
