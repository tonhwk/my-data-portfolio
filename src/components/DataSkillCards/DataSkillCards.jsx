  ...
  return (
    ...
    * Ability to work with APIs, web scraping, or data pipelines to collect and combine diverse datasets.</p>
      ...
      <Link to="https://github.com/tonhwk/git-cheat-sheet">
        ...
        <p className="info-card-description">Proficiency in version control systems like Git and collaboration platforms like GitHub by sharing my code repositories and contributions.
      * Ability to work effectively in team environments and collaborate on data analysis projects.</p>
      </Link>
      </div>
