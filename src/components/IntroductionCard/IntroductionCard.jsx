...
function IntroductionCard() {
  return (
    <div className="home-container">
        ...
        <p className="home-description">& Welcome to my data analysis portfolio! I specialize in transforming data into actionable insights. 
        Here, you'll find a collection of projects that demonstrate my expertise in exploring, analyzing, and visualizing data. 
        From market research to predictive modeling, each project showcases my passion for uncovering meaningful patterns and driving informed decisions. 
